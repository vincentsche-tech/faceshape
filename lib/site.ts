...
export const SITE = {
  ...
  description:
    "Open your camera and watch your face shape appear in real time — no photo to upload, no sign-up needed. Our live detector maps 468 facial landmarks in your browser and names your shape.",
};
